...
for cname in train_spanbert_large_conll12_classic \
             train_spanbert_large_conll12_gold \
             train_spanbert_large_conll12_goldconst \
             train_spanbert_large_conll12_predconst \
             train_spanbert_large_conll12_sing;
do
    MEM="32g"
#    name=${cname#train_}
